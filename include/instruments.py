...
class instruments:
    def __init__(self, required_instruments=None, vna_id=None):
        ...
        try:
            if vna_id:
                rm_vna = self.rm.open_resource(vna_id)
            else:
...
if __name__ == "__main__":
    instruments = instruments(required_instruments=['vna'], vna_id='TCPIP0::localhost::hislip0::INSTR')
