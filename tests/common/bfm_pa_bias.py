...
orion.DAC_CTRL_PA0_PDN.DAC_CTRL_PA0_PDN = 0  # 0 corresponds to -4.5V
orion.DAC_CTRL_PA0_PDN.write()
orion.DAC_CTRL_PA1_PDN.DAC_CTRL_PA1_PDN = 0  # 0 corresponds to -4.5V
orion.DAC_CTRL_PA1_PDN.write()
orion.DAC_CTRL_PA2_PDN.DAC_CTRL_PA2_PDN = 0  # 0 corresponds to -4.5V
orion.DAC_CTRL_PA2_PDN.write()
orion.DAC_CTRL_PA3_PDN.DAC_CTRL_PA3_PDN = 0  # 0 corresponds to -4.5V
