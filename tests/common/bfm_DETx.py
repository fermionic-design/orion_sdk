...
Line no: 14, give proper detector channel as input -  0 for DET0, 1 for DET1, 2 for DET2 and 3 for DET3
"""
det_ch_select = 0 # 0 for DET0, 1 for DET1, 2 for DET2 and 3 for DET3
import sys
...
adc_rf_only = measure_rf_only_adc(orion,det_ch_select)
