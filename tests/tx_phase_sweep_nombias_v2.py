...
ant_sel = 0x1
chip_id = 'AE123'
test_condition = 'max_bias_at_inp_p1dB_16dB_attn'
...
orion_hal.init_lut_new(r'C:/Users/silic/OneDrive/Documents/GitHub/orion/final_lut/TX_Gain_LUT_10p5GHz.xlsx',
                       r'C:/Users/silic/OneDrive/Documents/GitHub/orion/results/LUT/tx_v2__phase_lut_freq_14p25_gm_0p5_pm_1p5_pm2_4_abs_gain_8__maxbias__vdd_2p7.xlsx',
...
# Normalize
orion_hal.set_lut_idx(4,53,ant_sel)
orion_hal.stg2_load()
time.sleep(d1)
...
filename = f'C:/Users/silic/OneDrive/Documents/GitHub/orion/results/bench_char/tx_char__{version}__{chip_id}__ant_sel_{ant_sel}__{test_condition}__{ts}.xlsx'
...
for p_idx in range (4,125,1):
    orion_hal.set_lut_idx(p_idx,53,ant_sel)
    orion_hal.stg2_load()
    time.sleep(d1)
