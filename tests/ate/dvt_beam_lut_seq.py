...
orion_hal.set_tr_mask(tx_mask=ant_sel, rx_mask=ant_sel)
orion_hal.cfg_stg2_load('REG')  # PIN/REG
...
# use default values for start and stop address
...
# orion_csr.BEAM_CODE.beam_code=1
# orion_csr.BEAM_CODE.write()
# orion_csr.RSVD1.write()
# orion_csr.BEAM_CFG.write()
